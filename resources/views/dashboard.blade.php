                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div style="background-color: rgb(59, 195, 249)"
                                    ...
                                    <svg style="background-color: rgb(23, 166, 223)" class="icon rounded"
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div style="background-color: rgb(72, 237, 35)"
                                    class="icon-shape icon-shape-primary rounded me-4 me-sm-0">
                                    <svg style="background-color: rgb(62, 211, 29)" class="icon rounded"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z">
                                        </path>
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div style="background-color: rgb(249, 246, 32)"
                                    class="icon-shape icon-shape-primary rounded me-4 me-sm-0">
                                    <svg style="background-color: rgb(210, 207, 15)" class="icon rounded"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z">
                                        </path>
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div style="background-color: rgb(247, 36, 106)"
                                    class="icon-shape icon-shape-primary rounded me-4 me-sm-0">
                                    <svg style="background-color: rgb(214, 14, 81)" class="icon rounded"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z">
                                        </path>
                ...
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                    <div>
                        <div class="h5 mb-0 d-flex align-items-center" style="color: white">
                            <svg style="color: white" class="icon icon-xs me-2" fill="currentColor"
