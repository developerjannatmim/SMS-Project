    ...
    <div class="p-2 mb-0 mt-2">
      <div class="row" style="margin-right: 550px">
        <div class="col-12 col-md-4 col-xl-6">
          <p class="mb-0 text-center text-lg-start"><b class="">Edit Syllabus</b></p>
        ...
        <form method="POST" class="d-block ajaxForm" action="{{ route('admin.syllabus.update', $syllabus->id ) }}">
          ...
          <div class="form-row">
            <div class="fpb-7">
              ...
              <input class="form-control @error('title') is-valid @enderror" type="text" name="title" id="title" value="{{ $syllabus->title }}" required>
            </div>
