                      ...
                      <td class="text-start">
                        <div class="adminTable-action ms-0">
                            ...
                            <li>
                              ...
                              <li>
                                <a class="dropdown-item" href="{{ route('admin.edit.exam', ['id' => $exam->id]) , 'Edit Exam'}}">Edit</a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="{{ route('admin.exam.delete', ['id' => $exam->id]) , 'undefined'}}">Delete</a>
                              </li>
                            </ul>
                        </div>
                    </td>
