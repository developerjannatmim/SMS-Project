    ...
    <div class="p-2 mb-0 mt-2">
      <div class="row" style="margin-right: 550px">
        <div class="col-12 col-md-4 col-xl-6">
          ...
          <p class="mb-0 text-center text-lg-start"><small class="">Add - Users - Student Info</small>
          </p>
        </div>
      </div>
    </div>
    ...
    <section class="section" style="margin-top: -120px">
      ...
      <div class="bg-white rounded p-4 mb-4 mt-2">
        <form action="{{ route('admin.student.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mt-3">
            <button type="submit" class="btn btn-primary mt-2 animate-up-2">Add New Student</button>
          </div>
        </form>
      </div>
      </div>
