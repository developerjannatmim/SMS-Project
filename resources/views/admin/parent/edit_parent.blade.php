<x-layouts.base>
  ...
  <main class="content">
    ...
    <div class="p-2 mb-0 mt-2">
      <div class="row" style="margin-right: 550px">
        <div class="col-12 col-md-4 col-xl-6">
          ...
          <p class="mb-0 text-center text-lg-start"><small class="">Home - Users - Update Parent
              Info</small>
          </p>
        </div>
      </div>
    ...
    <div class="bg-white rounded p-4 mb-4 mt-2">
      ...
      <form action="{{ route('admin.guardian.update', $parent->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
