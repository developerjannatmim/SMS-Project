<x-layouts.base>
    ...
    <main class="content">
        ...
        <section class="section" style="margin-top: -120px">
            <a class="btn btn-primary" type="button" href="{{ route('admin.teacher') }}"
            ...
            <div class="bg-white rounded p-4 mb-4 mt-2">
                <form action="{{ route('admin.teacher.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input class="form-control @error('designation') is-valid @enderror" name="designation"
                                    type="text" placeholder="Enter your designation" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <button type="submit" class="btn btn-primary mt-2 animate-up-2">Add New Teacher Info</button>
                    </div>
                </form>
            </div>
            </div>
