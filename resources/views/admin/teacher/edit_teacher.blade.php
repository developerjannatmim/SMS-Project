        ...
        <div class="p-2 mb-0 mt-2">
            <div class="row">
                <div class="col-12 col-md-4 col-xl-6">
                    ...
                    <p class="mb-0 text-center text-lg-start"><small class="">Home - Users - Update Teacher Info</small>
                    </p>
                </div>
            </div>
        </div>
                            ...
                            <select name="class_id" class="form-select eChoice-multiple-with-remove" required
                                ...
                                @foreach ($classes as $class)
                                    <option value="{{ $class->id }}"
                                        {{ $teacher->class_id == $class->id ? 'selected' : '' }}>{{ $class->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select name="section_id" class="form-select eChoice-multiple-with-remove" required>
                                ...
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}"
                                        {{ $teacher->section_id == $section->id ? 'selected' : '' }}>{{ $section->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
