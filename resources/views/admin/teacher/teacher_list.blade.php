            ...
            <div class="p-2 mb-0 mt-2">
                <div class="row">
                    <div class="col-12 col-md-4 col-xl-6">
                        <p class="mb-0 text-center text-lg-start"><b class="">Teacher List</b></p>
                        <p class="mb-0 text-center text-lg-start"><small class="">Home - Users - Teacher
                                List</small>
                        </p>
                    </div>
                </div>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    ...
                                                    <div class="pl-3 email">
                                                        ...
                                                        <span style="color: rgb(147,128,139)"><b
                                                            ...
                                                            </b>{{ $teacher->class_id }}</span>
                                                        <span><b style="color: black">Section:
                                                            </b>{{ $teacher->section_id }}</span>
                                                    </div>
                                                </td>
                                                <td>{{ $teacher->email }}</td>
                                                        ...
                                                        <ul
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.teacher.create') }}">Add</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item"
