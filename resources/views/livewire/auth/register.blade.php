 <main>
    <title>Paramount Dashboard - Sign Up page</title>
        <!-- Section -->
        <section class="vh-lg-100 mt-5 bg-soft d-flex align-items-center">
            <div class="container">
                            ...
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="name" id="name" type="name" class="form-control" placeholder="Name" autofocus required>
                                    </div>
